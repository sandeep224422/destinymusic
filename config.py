...
LOGGER_ID = int(getenv("LOGGER_ID",-1002638427943))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/sandeep224422/destinymusic",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/i493lf.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/i493lf.jpg")
