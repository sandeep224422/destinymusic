...
```
 єxᴧϻᴘʟє : @destinyy_music_bot @crush_hu_tera I love You 😘
```
...
─────────────────────────
❍ ᴄσηᴛᴧᴄᴛ - [🦋⃟�𝙚𝙨𝙩𝙞𝙣�~](https://t.me/crush_hu_tera)
─────────────────────────**
'''
    HELP_ABOUT = '''
**─────────────────────────
│ ᴡєʟᴄσϻє ᴛσ [🦋⃟�𝙚𝙨𝙩𝙞𝙣�~](https://t.me/destinyy_music_bot)˼ ʙσᴛ sᴛᴧᴛυs │
─────────────────────────
       ❖ │ ʀєᴧʟ ᴛɪϻє ʙσᴛ's sᴛᴧᴛυs │❖
─────────────────────────
╭⎋ [🦋⃟�𝙚𝙨𝙩𝙞𝙣�~](https://t.me/destinyy_music_bot) : ᴧʟɪᴠє 
...
─────────────────────────
❍ 𝐏ᴏᴡєʀєᴅ 𝖡ʏ » [メ乛𝐙 𝐄 𝐅 𝐑 𝐎 𝐍 ⚡️](https://t.me/crush_hu_tera)
─────────────────────────**
'''
    HELP_ALLBOT = '''
**─────────────────────────
...
─────────────────────────
❖ υᴘᴅᴧᴛєs ᴄʜᴧηηєʟ ➥ [🦋⃟�𝙚𝙨𝙩𝙞𝙣�~](https://t.me/bots_update_all)
❖ sυᴘᴘσʀᴛ ᴄʜᴧᴛ ➥ [⃟�𝙚𝙨𝙩𝙞𝙣𝙮~](https://t.me/about_zefron)
❖ ʀєᴘσ ʟɪηᴋ ➥ [ᴄʟɪᴄᴋ-ʜєʀє](https://t.me/destinyy_music_bot?start=_tgr_fBSoVjdmODhl)
─────────────────────────
